...
# This program is aim to calculate crime tweets from Twitter by Serach API
...
db = couch.create('VictoriaPolice')
...
# Add post code to each crime tweet
...
# Ensure tweet data in Melbourne
